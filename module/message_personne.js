...
module.exports = function(client){
        ...
        client.on('message', message =>{
            if(message.content === 'UN BRONZE AVEC TEEMO EN URF') {
                ...
                console.log('Video de Golden mis par: '+ message.author.username);
            }

            if(message.content === 'Diego') {
                // sa envoie le message
                message.channel.send(diego + ' ou est Dora ? \n http://urlz.fr/5I3T');
                console.log('"Diego" mis par: '+ message.author.username);
            }
            ...
            if(message.content === 'freez') {
                ...
                console.log('"freez" mis par: '+ message.author.username);
            }
            ...
            if(message.content === 'golden'){
                ...
                console.log('"golden" mis par: '+ message.author.username);
            }
            ...
            if(message.content === 'Twido') {
                ...
                console.log('"Twido" mis par: ' + message.author.username);
            }
